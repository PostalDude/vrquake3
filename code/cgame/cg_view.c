...
*/
	...
	else 
	{
		...
		CG_OffsetFirstPersonView();  //*** Adjust view height		
	}*/
	...
	/*	float d = 10.01f;
		...
		VectorCopy( cg.refdef.viewaxis[1], transformed );
		RotatePointAroundVector( cg.refdef.viewaxis[1], cg.refdef.viewaxis[ROLL], transformed, cg.refdefViewAngles[1] );
		CrossProduct( cg.refdef.viewaxis[1], cg.refdef.viewaxis[0], cg.refdef.viewaxis[1] );*/
	}
...
void CG_DrawActiveFrame( int serverTime, stereoFrame_t stereoView, qboolean demoPlayback ) {
	...
	//***CG_AddViewWeapon( &cg.predictedPlayerState ); //*** Add weapon to view
