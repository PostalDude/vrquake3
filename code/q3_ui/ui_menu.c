...
static void Main_MenuDraw( void ) {
	...
	adjust =  1.0 * sin( (float)uis.realtime / 1000 ); // JDC: Kenneth asked me to stop this 1.0 * sin( (float)uis.realtime / 1000 );
	refdef.fov_x = 110 + adjust;  //*** Changed FOV from 60 to 110
