...
#else
  #define PRODUCT_NAME			"vrq3"
  #define BASEGAME			"baseq3"
  #define CLIENT_WINDOW_TITLE     	"vrquake3"
  #define CLIENT_WINDOW_MIN_TITLE 	"vrq3"
...
#define CONSOLE_SMALLCHAR_WIDTH		16
#define CONSOLE_SMALLCHAR_HEIGHT	32
